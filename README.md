...
📋 Gereksinimler
Gereksinim	Notlar
Python 3.10+	python.org — kurulumda "Add to PATH" seçeneğini işaretle
Git	git-scm.com — LtMAO otomatik kurulumu için gerekli
...
`` → Champion adı gir (örn: Ahri, Zed, Katarina)

Skin listesi açılır — her skin yanında renk bloğu ve türü gösterilir

Ctrl+Click ile skin ismesine tıklayarak CDragon'dan splash art önizleyebilirsin
...
.fantome dosyaları seçilen klasöre kaydedilir (varsayılan: masaüstü/Extracted)
...
text
Menü  → Ayarlar → League Path'i değiştir
Varsayılan yol: C:\Riot Games\League of Legends

❓ SSS
<details> <summary><b>Git kurulu değil, LtMAO nasıl kuracağım?</b></summary>
git-scm.com adresinden Git'i kur, ardından python build.py çalıştır. Tool LtMAO'yu otomatik indirir.

</details> <details> <summary><b>Hash indirmesi çok uzun sürüyor?</b></summary>
İlk açılışta normaldir (~1-2 dakika). Bir kez indirildikten sonra önbelleğe alınır, bir daha indirilmez.

</details> <details> <summary><b>"Champions dir not found" hatası aldım?</b></summary>
Menü `` → Ayarlar'dan League of Legends'ın kurulu olduğu klasörü doğru gir.

</details> <details> <summary><b>Champion seçince "Skin bulunamadı" hatası alıyorum?</b></summary>
League kurulum yolunun doğru olduğunu kontrol et. Menü `` → Ayarlar → League Path'i düzenle. Yol ...\League of Legends klasörüne işaret etmeli, içindeki alt klasörlere değil.

</details> <details> <summary><b>Ctrl+Click splash art açılmıyor?</b></summary>
...
</details> <details> <summary><b>Skin extract ettim ama oyunda çalışmıyor?</b></summary>
.fantome dosyasını cslol-manager veya League Toolkit üzerinden yüklemelisin. Dosyaya çift tıklamak çalıştırmaz.

</details> <details> <summary><b>Chromalar neden ayrı dosya olarak çıkıyor?</b></summary>
...
🙏 Credits & Teşekkürler
Bu proje bettie9/league-skin-fantome-builder reposundan ilham alınarak geliştirilmiştir.
...
LtMAO — WAD okuma & BIN bin-swap motoru

CommunityDragon — skin kataloğu, hash verileri & splash art

Riot DataDragon — champion & skin ID'leri
